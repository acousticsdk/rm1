...
export default function FinancialManagerModal({ visible, onClose }) {
  ...
  const handleCancel = () => {
    // Просто закрываем модалку финансового менеджера
    // НЕ вызываем onClose, чтобы банковская модалка осталась открытой
    // Используем внутреннее состояние или просто скрываем эту модалку
  };
