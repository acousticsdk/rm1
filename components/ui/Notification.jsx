...
const styles = StyleSheet.create({
  container: {
    position: 'absolute',
    top: typeof Platform !== 'undefined' && Platform.OS === 'web' ? 20 : 60,
    left: 20,
    right: 20,
  ...
  title: {
    ...
    fontSize: 16,
    fontWeight: '600',
    fontFamily: typeof Platform !== 'undefined' && Platform.OS === 'web' ? 'system-ui' : 'Codec-Pro-Bold',
  },
  message: {
    color: '#CCCCCC',
    fontSize: 14,
    marginTop: 2,
    fontFamily: typeof Platform !== 'undefined' && Platform.OS === 'web' ? 'system-ui' : 'Codec-Pro-News',
  },
});